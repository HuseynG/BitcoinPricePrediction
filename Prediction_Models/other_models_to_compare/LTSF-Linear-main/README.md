# NOTE: The code content found in the directory named 'LTSF-Linear-main' has been cloned or retrieved from the following source for the sole purpose of comparison: https://github.com/cure-lab/LTSF-Linear. It has undergone slight modifications for the purpose of analysis and evaluation. I want to clarify that I do not claim to be the original developer of the code in this directory. Proper referencing and credit are given to the original authors.The research paper related to this code can be found at the following link: https://arxiv.org/pdf/2205.13504.pdf. This paper provides valuable insights into the underlying methods and algorithms used in the development of the code.
